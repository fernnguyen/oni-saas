...
export const hrmEmployeeProfiles = pgTable(
  'hrm_employee_profiles',
  {
    ...
    tax_code: varchar('tax_code', { length: 20 }),
    insurance_code: varchar('insurance_code', { length: 20 }),
...
export const hrmSettings = pgTable('hrm_settings', {
  ...
  attendance_rules: jsonb('attendance_rules'),
  created_at: auditTimestamp('created_at'),
  updated_at: auditTimestamp('updated_at'),
}, (table) => [
...
export const hrmAttendanceDays = pgTable(
  'hrm_attendance_days',
  {
    ...
    clock_in_source: varchar('clock_in_source', { length: 50 }),
    clock_in_metadata: jsonb('clock_in_metadata'),
    clock_out_source: varchar('clock_out_source', { length: 50 }),
    clock_out_metadata: jsonb('clock_out_metadata'),
    note: text('note'),
