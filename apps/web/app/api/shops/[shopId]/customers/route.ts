...
export async function GET(
  ...
  try {
    ...
    const result = nocache
      ...
      : await shopCache(
          fetchCustomers,
          ['customers', shopId, search, customer_type, sort_by, sort_order, String(show_merged), String(shareCustomers)],
    ...
    const slicedData = result.data.slice(offset, offset + limit)
