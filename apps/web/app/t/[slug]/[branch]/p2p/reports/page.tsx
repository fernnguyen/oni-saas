...
import { P2PReportsClient } from './P2PReportsClient';

interface Props {
  params: Promise<{ slug: string; branch: string }>;
}

export default async function P2PReportsPage({ params }: Props) {
  ...
  return <P2PReportsClient shopId={shop.id} shopName={shop.name} userId={authData.user.id} />;
}
