      ...
      <section className="relative py-24 md:py-32 bg-slate-50 border-t border-slate-200 overflow-hidden text-center">
        ...
        <div className="relative mx-auto max-w-4xl px-6 z-10">
          ...
          <p className="text-base sm:text-lg text-slate-650 font-medium mb-10 max-w-2xl mx-auto">
            Bắt đầu bán hàng ngay với gói Tiên phong miễn phí vĩnh viễn. Nâng cấp linh hoạt khi mở rộng chuỗi nhiều chi nhánh.
          </p>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-bold text-slate-500">
            <div className="flex flex-wrap gap-x-8 gap-y-2 justify-center">
              ...
              <Link href={`/register?industry=${detail.slug}`} className="hover:text-white transition-colors">Đăng ký Gói Tiên phong miễn phí</Link>
            </div>
