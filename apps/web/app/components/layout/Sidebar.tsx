...
const navGroups: { label?: string; items: NavItem[] }[] = [
  {
    items: [
      { href: '/dashboard', label: 'Tổng quan', icon: IconHome, exact: true },
    ],
  },
  {
    ...
    items: [
      ...
      { href: '/dashboard/returns', label: 'Đơn trả hàng', icon: IconReturn },
    ],
  },
  {
    label: 'Vận hành',
    items: [
      { href: '/dashboard/shipping', label: 'Vận chuyển', icon: IconTruck },
      { href: '/dashboard/inventory', label: 'Kho', icon: IconWarehouse },
      { href: '/dashboard/partners', label: 'Quản lý đối tác', icon: IconUsers },
    ],
  },
  {
    label: 'Kênh bán hàng',
    items: [
      { href: '/dashboard/channels/facebook', label: 'Facebook', icon: IconFacebook },
      { href: '/dashboard/channels/ecom', label: 'Sàn TMĐT', icon: IconShop },
      { href: '/dashboard/channels/pos', label: 'Bán tại quầy', icon: IconPos },
    ],
  },
  {
    label: 'Báo cáo',
    items: [
      { href: '/dashboard/reports/accounting', label: 'Kế toán', icon: IconChart },
      { href: '/dashboard/reports/cod', label: 'Đối soát COD', icon: IconMoney },
  ...
  },
  {
    label: 'Hệ thống',
    items: [
      { href: '/dashboard/tenants', label: 'Tổ chức', icon: IconBuilding },
      { href: '/dashboard/connectors', label: 'Kết nối dữ liệu', icon: IconPlugin },
      { href: '/dashboard/settings', label: 'Cài đặt', icon: IconSettings },
    ],
  },
];
