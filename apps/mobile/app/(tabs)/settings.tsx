      ...
      <ScrollView className="flex-1 px-4 py-4" showsVerticalScrollIndicator={false}>
        ...
        <View className="p-4 rounded-2xl border bg-white border-slate-100 shadow-sm mb-4">
          <View className="flex-row items-center justify-between">
            <View className="flex-row items-center">
              ...
              <View>
                ...
                <Text className="text-[8px] text-slate-400 font-bold mt-0.5 uppercase tracking-wider">
          ...
          <View className="border-t border-slate-100 my-4 pt-4 flex-row justify-between items-center">
            <View>
              <Text className="text-[8px] text-slate-400 font-bold uppercase tracking-wider">Chi nhánh hoạt động</Text>
              <Text className="text-xs font-black mt-0.5 text-slate-700">
                {branchName}
              </Text>
            </View>
        ...
        <Text className="text-[9px] font-black text-slate-450 uppercase tracking-widest mb-3 px-1">
        ...
        <View className="p-4 rounded-2xl border bg-white border-slate-100 shadow-sm mb-4">
          ...
          <View className="flex-row bg-slate-50 p-1 rounded-xl mb-4 border border-slate-200">
            ...
            >
              ...
              <Text className={`text-[9px] font-black ml-1.5 uppercase tracking-wider ${
          ...
          {printerConnType === 'bluetooth' ? (
            <View className="mb-4">
              <Text className="text-[9px] text-slate-450 font-black uppercase tracking-wider mb-2">Chọn thiết bị Bluetooth</Text>
            ...
            <View className="mb-4">
              <Text className="text-[9px] text-slate-455 font-black uppercase tracking-wider mb-2">Thông tin địa chỉ IP máy in LAN</Text>
        ...
        <View className="p-4 rounded-2xl border bg-white border-slate-100 shadow-sm mb-4">
          ...
          <View className="mb-4">
            <View className="flex-row justify-between py-1.5 items-center border-b border-slate-100 pb-2">
              <Text className="text-[9px] text-slate-450 font-black uppercase">SQLite Row Stats:</Text>
              <Text className="text-[9px] font-black text-[#fa5908]">
            ...
            <View className="flex-row justify-between py-2 items-center border-b border-slate-100">
              <Text className="text-[9px] text-slate-455 font-black uppercase">Full Sync gần nhất:</Text>
              <Text className="text-[9px] font-extrabold text-slate-600">{lastFullSync}</Text>
            </View>
            <View className="flex-row justify-between py-2 items-center border-b border-slate-100">
              <Text className="text-[9px] text-slate-455 font-black uppercase">Delta Sync gần nhất:</Text>
              <Text className="text-[9px] font-extrabold text-slate-600">{lastDeltaSync}</Text>
            </View>

            <View className="mt-3.5 bg-slate-50 p-3 rounded-xl border border-slate-100">
              <Text className="text-[9px] font-bold text-slate-500 leading-relaxed text-center">
          ...
          {syncProgress !== null && (
            <View className="mb-4 bg-slate-50 p-3 rounded-xl border border-slate-200">
              <View className="flex-row justify-between mb-1.5">
                <Text className="text-[9px] font-black text-slate-700 uppercase tracking-wider">Đang đồng bộ SQLite...</Text>
                <Text className="text-[9px] text-orange-500 font-black">{syncProgress}%</Text>
              </View>
        ...
        <View className="p-4 rounded-2xl border bg-white border-slate-100 shadow-sm mb-10">
          ...
          <View className="flex-row justify-between items-center py-3 border-b border-slate-100">
            <View className="flex-1 mr-4">
              ...
              <Text className="text-[8px] text-slate-400 font-bold mt-0.5">Giảm thiểu tối đa độ trễ dữ liệu</Text>
            </View>
            <Switch
          ...
          <View className="flex-row justify-between items-center py-3">
            <View className="flex-1 mr-4">
              ...
              <Text className="text-[8px] text-slate-400 font-bold mt-0.5">Phát tiếng Beep khi quét barcode thành công</Text>
            </View>
            <Switch
              value={soundFeedback}
