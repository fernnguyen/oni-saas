      ...
      <View className="p-4 bg-white border-b border-slate-150">
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} className="flex-row">
          ...
          {['VIP', 'Thân thiết', 'Thành viên'].map(tier => (
            ...
            >
              <Text className={`text-[10px] font-bold uppercase tracking-wider ${selectedFilter === tier ? 'text-white' : 'text-slate-600'}`}>
                {tier}
              </Text>
            </TouchableOpacity>
          ))}
                ...
                >
                  <View className="flex-row items-center flex-1 mr-3">
                    <View className="w-11 h-11 rounded-2xl items-center justify-center border-2 mr-3 bg-orange-50 border-orange-200 text-orange-600">
                      <Text className="font-bold text-base uppercase text-orange-600">{avatarChar}</Text>
                    </View>
                    ...
                    <View className="flex-shrink-1">
                      <View className="flex-row items-center flex-wrap">
                        ...
                        <View className="px-1.5 py-0.5 rounded-md border bg-slate-100 border-slate-200">
                          <Text className="text-[7px] font-bold uppercase text-slate-500">
                    ...
                    <View className="flex-row items-center mt-2.5">
                      {isPending ? (
                        <View className="bg-amber-50 px-2 py-0.5 rounded border border-amber-300 mr-2">
                          <Text className="text-[7px] font-black text-amber-700 uppercase">Offline</Text>
                        </View>
                      ) : (
                        <View className="bg-emerald-50 px-2 py-0.5 rounded border border-emerald-300 mr-2">
                          <Text className="text-[7px] font-black text-emerald-700 uppercase">Synced</Text>
                        </View>
                      )}
        ...
        <View className="flex-1 justify-end bg-black/60">
          <View className="h-[55%] rounded-t-[32px] p-6 justify-between bg-white">
            ...
            <ScrollView className="flex-1 my-4">
              <Text className="text-xs text-slate-500 font-extrabold mb-1.5 uppercase">Tên khách hàng</Text>
              <TextInput
              ...
              <Text className="text-xs text-slate-500 font-extrabold mb-1.5 uppercase">Số điện thoại</Text>
              <TextInput
              ...
              <Text className="text-xs text-slate-500 font-extrabold mb-1.5 uppercase">Hạng thành viên</Text>
            ...
            >
              {isSaving ? (
                ...
                <>
                  ...
                  <Text className="text-white font-extrabold text-sm ml-1.5 uppercase tracking-wide">Lưu khách hàng (Offline & Sync)</Text>
                </>
              )}
            </TouchableOpacity>
          </View>
