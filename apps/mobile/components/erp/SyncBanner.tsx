...
export function SyncBanner({ shopId, forceStatus, onPressSync, isSyncing = false }: SyncBannerProps) {
  ...
  if (status === 'offline') {
    return (
      ...
      >
        ...
        <Text className="text-[8px] font-bold text-amber-700 uppercase tracking-wider ml-1">
  ...
  return (
    ...
    >
      ...
      <Text className="text-[8px] font-black text-rose-600 uppercase tracking-wider ml-1">
        Lỗi kết nối
      </Text>
    </TouchableOpacity>
  );
