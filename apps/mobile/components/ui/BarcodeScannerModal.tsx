    ...
    if (!permission.granted) {
      ...
      return (
        <View className="flex-1 justify-center items-center px-6 py-8 bg-slate-50">
          ...
          <Text className="text-base font-extrabold text-slate-800 text-center mb-2">
          ...
          >
            ...
            <Text className="text-xs font-black text-white ml-2">Cấp quyền Camera</Text>
          </TouchableOpacity>
        </View>
      );
    }
                    ...
                    <View style={StyleSheet.absoluteFillObject} className="justify-between items-center pointer-events-none">
                      ...
                      <View className="w-full flex-1 bg-black/60 items-center justify-between py-6">
                        ...
                        >
                          ...
                          <Text className="text-[10px] font-bold text-white ml-2">
                  ...
                  <View className="flex-1">
                    {permission?.granted === false ? (
                      ...
                      <View className="flex-1 justify-center items-center p-6 bg-slate-50">
                        ...
                        <Text className="text-sm font-extrabold text-slate-800 text-center mb-1">
                          Chế độ giả lập & Web
                        </Text>
                        ...
                        <View className="w-full bg-white border border-slate-200 rounded-2xl p-4.5" style={{ shadowColor: '#000000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.04, shadowRadius: 4, elevation: 2 }}>
                          <Text className="text-[9.5px] text-slate-400 font-extrabold uppercase mb-2">Nhập mã vạch thủ công:</Text>
                          ...
                          >
                            ...
                            />
                            <Text className={`text-xs font-black ml-2 ${
                ...
                {isCameraReady && showManualInput && (
                  <View className="absolute bottom-0 left-0 right-0 p-4.5 bg-white border-t border-slate-100 rounded-t-2xl z-20" style={{ shadowColor: '#000000', shadowOffset: { width: 0, height: -4 }, shadowOpacity: 0.08, shadowRadius: 8, elevation: 10 }}>
                    <View className="flex-row justify-between items-center mb-2">
                      <Text className="text-[9.5px] text-slate-400 font-extrabold uppercase">Nhập mã vạch sản phẩm:</Text>
                      <TouchableOpacity onPress={() => setShowManualInput(false)}>
                        <Text className="text-[10px] text-orange-600 font-bold">Đóng</Text>
                      </TouchableOpacity>
                    </View>
