...
export function useTableManager(isNavReady: boolean, isLoading: boolean, showToast: any) {
  ...
  // Time ticker effect for re-rendering open tables duration
...
const triggerPayTable = (table: any) => {
 ...
 setIsPayingCartLoading(false);
  ...
  return {
    ...
    isTablePayDialogVisible, setIsTablePayDialogVisible,
    selectedTableForPay, setSelectedTableForPay,
    timeTicker,
    calculateBilling,
